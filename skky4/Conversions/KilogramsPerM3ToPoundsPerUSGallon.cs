...
{
	public class KilogramsPerM3ToPoundsPerUSGallon : ConversionBase
	{
		public const double Const_ConversionFactor = 119.8264273;

		public override ConversionIdentifiers GetIdentifier()
		{
			return ConversionIdentifiers.KilogramsPerM3ToPoundsPerUSGallon;
		}
